...
import {
  BultoPanel,
  BultoSimSnapshot,
} from "../simulacion/[loteId]/BultoPanel";
...
export function SimulacionClient({
  ...
  return (
    <section className="space-y-5">
      {/* Header */}
      <header className="rounded-xl border bg-white p-4 md:p-5 shadow-sm">
      ...
      <div className="grid gap-5 xl:grid-cols-12">
        {/* Panel 1 */}
        <div className="xl:col-span-3 rounded-xl border bg-white p-4 shadow-sm">
          <BultoPanel
            lote={lote}
            onApply={(snap) => {
              setBultoSnap(snap);
              // por ahora solo lo guardamos en estado local
              // mañana lo usamos para alimentar el pallet/camión
              console.log("BULTO SNAP APLICADO:", snap);
            }}
          />

          {bultoSnap && (
            <div className="mt-3 rounded-lg border bg-emerald-50 p-3 text-xs text-emerald-800">
              Aplicado:{" "}
        ...
        <div className="xl:col-span-7">
          {/* Le damos aire: evitamos que el PalletClient quede “aplastado” */}
          <div className="rounded-xl border bg-white shadow-sm">
            ...
            <div className="p-4">
              {/* Reusa el componente actual sin tocarlo */}
              <PalletClientV2
                empresaId={empresaId}
                lote={lote as any}
